                                    ...
                                    <div class="col-sm-7">
                                        <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail">
                                                ...
                                                @else
                                                    <img src="{{ asset('material') }}/img/image_placeholder.jpg"
                                                        alt="...">
                                                @endif
                                            </div>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('slug') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('slug') ? ' is-invalid' : '' }}"
                                                ...
                                                placeholder="{{ __('Slug') }}"
                                                value="{{ old('slug', $article->slug) }}" required="true"
                                                aria-required="true" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('category_id') ? ' has-danger' : '' }}">
                                            ...
                                            @include('dashboard.alerts.feedback', [
                                                'field' => 'category_id',
                                            ])
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('author_id') ? ' has-danger' : '' }}">
                                                <select class="selectpicker col-sm-12 pl-0 pr-0" name="author_id"
                                                    data-style="select-with-transition" title="" data-size="100">
                                                    <option value="">-</option>
                                                    @foreach ($authors as $author)
                                                        <option value="{{ $author->id }}"
                                                            {{ $author->id == old('author_id', $article->author_id) ? 'selected' : '' }}>
                                                            {{ $author->name }}</option>
                                                    @endforeach
                                                </select>
                                                @include('dashboard.alerts.feedback', [
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('excerpt') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('excerpt') ? ' is-invalid' : '' }}"
                                                name="excerpt" id="input-excerpt" type="text"
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('tags') ? ' has-danger' : '' }}">
                                            <select class="selectpicker col-sm-12 pl-0 pr-0" name="tags[]"
                                                data-style="select-with-transition" multiple title="-"
                                                data-size="7">
                                                @foreach ($tags as $tag)
                                                    <option value="{{ $tag->id }}"
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('date') ? ' has-danger' : '' }}">
                                            <input type="text" name="publish_date" id="publish_date"
                                                ...
                                                value="{{ old('publish_date', $article->publish_date ? $article->publish_date->format('d-m-Y') : '') }}" />
                                            @include('dashboard.alerts.feedback', [
                                                'field' => 'publish_date',
                                            ])
                                        </div>
