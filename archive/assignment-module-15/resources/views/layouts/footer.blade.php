<footer class="py-5">
    <div class="container text-center pb-5 border-bottom">
      ...
      <ul class="d-flex flex-wrap justify-content-center align-items-center list-unstyled mb-4">
        ...
        <li><a class="link-secondary me-4" href="#about">Company</a></li>
        <li><a class="link-secondary me-4" href="#pricing">Services</a></li>
        <li><a class="link-secondary" href="#team">Testimonials</a></li>
      </ul>
      <div>
