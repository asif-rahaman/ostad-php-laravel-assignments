            ...
            <div class="blog-author d-flex align-items-center">
              ...
              <div>
                ...
                <div class="social-links">
                  <a href="https://twitters.com/#" aria-label="Social Media URL"><i class="bi bi-twitter"></i></a>
                  <a href="https://facebook.com/#" aria-label="Social Media URL"><i class="bi bi-facebook"></i></a>
                  <a href="https://instagram.com/#" aria-label="Social Media URL"><i class="biu bi-instagram"></i></a>
                </div>
                <p>
                ...
                <form action="">
                  ...
                  <div class="row">
                    ...
                    <label for="website" class="d-none">Website</label>
                      <input name="website" id="website" type="text" class="form-control" placeholder="Your Website">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
