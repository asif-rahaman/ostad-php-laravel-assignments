...
/**In this assignment, you will create a personal blog using HTML, CSS, and PHP. 
 * Your blog should have multiple pages, including 
 * a home page, 
 * a blog page, and a 
 * contact page. 
 * Here are the requirements for the blog:
 * Homepage: Create a homepage that displays a header with a logo, navigation menu, and a featured post section with a title, image, and excerpt from the latest blog post. 
 * The navigation menu should have links to other pages on the website, including 
 * the blog page and 
 * the contact page.
 
 * Blog page: Create a blog page that displays a list of blog posts, 
    * with the most recent post at the top. 
    * Each blog post should have a title, image, excerpt, and a "Read More" button that links to the full post. 
    * Include a sidebar with a search bar and a list of categories.
